...
- `QualityAgent` читает проверки серы, T95, цетанового числа и плотности. Нарушение или неизвестный обязательный
...
Проверяющие классы качества и надёжности — обычные Python-классы с чёткими правилами и не вызывают LLM.
