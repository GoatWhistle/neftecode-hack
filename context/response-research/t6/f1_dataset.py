"""F1a (T6/F9): 30-min decision grid dataset. Copy of final/f1_dataset.py with T_in = ht.T6, feed = ht.F9. Output out/ds_final.pkl.
...
for v in ["T_in", "T_out", "T5", "feed", "feed_vol", "prod_vol", "P", "dP", "h2oil", "gas2", "gas22", "gas25", "dT_reactor"]:
    d[v] = wmean(v, -30, 0, times)
d["density"] = d.feed / d.feed_vol
