"""F1b (SELECT only): which ACTION definition and HORIZON. Caches DML residuals for F2/F3.
...
NUIS = ["T_in", "T_out", "dT_reactor", "feed", "P", "dP", "h2oil", "gas2", "gas22", "gas25", "quench", "density",
