...
| Z9 | Сплошная сверка заявлений экрана/документов с кодом (владелец добавил 21.09 по внешней критике) | ⏳ ожидает | | Только чтение, без правок кода; каждое расхождение — новая строка здесь с ID | |
...
| N1 | Сервер: признак некалиброванной самооценки у `confidence` (владелец добавил 21.09) | ⏳ ожидает | | | |
| N1-фронт | Убрать число «уверенности» | ⏳ ожидает | | | |
