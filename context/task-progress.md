...
| Z4 | Тест эквивалентности demo = live = gateway | 🔄 в работе | | субагент вернул диф, проверяю | 2026-09-21 |
| Z5 | Регрессия 24.07 + `frozen_pak` → hold | 🔄 в работе | | субагент вернул диф, проверяю | 2026-09-21 |
| Z6 | Обновить `problems.md` | ✅ выполнено | `245adf5` | #4,#5 закрыты, #7 частично, добавлены #10 (стек) и #11 (T02), правило реестра | 2026-09-21 |
| Z7 | `organizer-clarifications.md` и `parameters.json`: резервуар 5000 м³ | 🔄 в работе | | субагент вернул диф (given-факты 5000 м³/12ч/24ч), `uv run pytest -q` — 1357 passed 2 skipped — проверяю причину skip | 2026-09-21 |
