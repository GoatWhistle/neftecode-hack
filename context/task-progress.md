...
Сводка: выполнено 0, передано фронту 0, заблокировано 0. Текущий этап: 0.
...
| Z2 | Полный `pytest` и `npm run build`, зафиксировать базу | ⏳ ожидает | | | |
...
| Z0 | Файл прогресса задач (этот файл) | 🔄 в работе | | | |
