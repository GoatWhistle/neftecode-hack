...
| B2 | ✅ выполнено | текущий коммит | `LLM_PROVIDER=scripted uv run pytest -q tests/agentic/test_safety.py` — 39 passed | Ограничения и veto сохраняются после сбоев оркестратора, resolve, release и guard. Повторный сбой recovery даёт отказ с трассой, а не запрещённый legacy-план. |
| B3 | ⏳ ожидает | — | — | — |
| B4 | ⏳ ожидает | — | — | — |
| B5 | ⏳ ожидает | — | — | — |
| B6 | ⏳ ожидает | — | — | — |
