...
> Исторический чек-лист. По состоянию на 19.09 кодовые пункты O01–O10 закрыты; O08 обновлён по окончательному
> решению: начало отклика 2 ч, окно плато 3–8 ч отдельно. O11 осознанно не выполнялся. Единственные внешние
> блокеры промышленного применения вынесены в `deployment_readiness`: параметры парка и мощность глубокой очистки.
