...
| Hard-constraint gate | Единая обязательная проверка кандидата и окончательного решения | `domain/advisory/gate.py`; полная сетка и обязательные поля, terminal inventory — только при включённой политике |
