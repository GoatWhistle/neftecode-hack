...
- `.env` в `.gitignore` (добавлено 2026-09-16 коммитом 0ae092f: раньше файл не игнорировался; в истории git его нет). Ключ не передаётся субагентам и не печатается, даже частично.
