...
Для участников того же Tailscale tailnet доступен частный адрес
`http://[fd7a:115c:a1e0::3401:8bdd]:8080/`. Caddy слушает этот порт только на
Tailscale IPv6. Этот маршрут помогает при недоступности публичного IP из
отдельных сетей; шифрование трафика обеспечивает Tailscale.
