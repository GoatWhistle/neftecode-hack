"""Частичная проверка оценки резервуара: сверка среднего доверенных ПАК с пробой ЛИМС в момент отбора."""
import numpy as np
import pandas as pd
...
def test_the_check_reports_error_bias_and_correlation_per_window():
    ...
    # ЛИМС на 0.2 выше потока: смещение оценки отрицательное для любого окна.
