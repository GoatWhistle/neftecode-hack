"""Contracts must keep unknown separate from zero, and advice separate from execution."""
import json
...
# --- Observation: sample time and availability time are different things ---
...
# --- PlantState: no future data may enter the decision ---
...
# --- PendingAction: advice is not execution ---
...
# --- Gate: unknown blocks, and feasibility is derived ---
...
# --- Plan: keeping the regime is a real candidate ---
