...
function withUnit(value, unit, digits = 3) {
  const text2 = num(value, digits);
  return text2 === "—" ? text2 : `${text2} ${unit}`;
}
...
function Field({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "field__label", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "field__value", children })
  ] });
}
function Fields({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("dl", { className: "fields", children });
}
function Empty({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "empty", children: children ?? `Данные этого блока не передавались (${MISSING})` });
}
function Note({ children, tone = "plain" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `note note--${tone}`, children });
}
function Tag({ children, tone = "idle" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `tag tag--${tone}`, children });
}
...
async function fetchOptions(scenario) {
...
function TankField({ conditions, tanks, tank, disabled, onChange }) {
  if (tanks.length === 0) return null;
  const pick = (id) => {
    const next = tanks.find((item) => item.id === id) ?? null;
    onChange({
      tank: id,
      tank_inventory: next?.inventory === null || next?.inventory === void 0 ? "" : String(next.inventory),
      tank_available: next ? next.available ? "1" : "0" : ""
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "config__field", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Резервуар" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: conditions.tank, disabled, onChange: (event) => pick(event.target.value), children: tanks.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: item.id, children: item.id }, item.id)) })
    ] }),
    tank?.on_demand ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "config__hint", children: [
      "Компонент ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: tank.id }),
      " нарабатывают по необходимости: запаса на складе у него нет, менять нечего."
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "config__field", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Запас резервуара, т" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "number",
          step: "10",
          value: conditions.tank_inventory,
          disabled,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "config__field", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Доступность резервуара" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          value: conditions.tank_available,
          disabled,
          onChange: (event) => onChange({ tank_available: event.target.value }),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "в работе" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "0", children: "выведен" })
          ]
        }
      )
    ] })
...
function ConfigStage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "config", className: "config", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "config__head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "config__step", children: "0" }),
    ...
    options === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "config__offline", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "config__field", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            children: options.scenarios.map((name) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: name, children: name }, name))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "config__field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Момент решения" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            value: conditions.snapshot,
            disabled: running,
            onChange: (event) => onChange({ snapshot: event.target.value }),
            children: options.snapshots.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: item.key, children: item.title }, item.key))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "config__field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Отказ источника" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            value: conditions.fault,
            disabled: running,
            onChange: (event) => onChange({ fault: event.target.value }),
            children: options.faults.map((name) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: name, children: FAULT_LABELS[name] ?? name }, name))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        NumberField,
        {
          label: "Сера сырья, % масс.",
          step: "0.01",
          value: conditions.crude_sulfur_wt_pct,
          disabled: running,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        NumberField,
        {
          label: "Предел серы продукта, мг/кг",
          step: "0.5",
          value: conditions.product_sulfur_mgkg,
          disabled: running,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        NumberField,
        {
          label: "Предел T95, °C",
          step: "1",
          value: conditions.product_t95_c,
          disabled: running,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        NumberField,
        {
          label: "Минимум цетанового числа",
          step: "0.5",
          value: conditions.product_cetane_number,
          disabled: running,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "config__actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "stage__head", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stage__step", children: index }),
          ...
          source ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "stage__source", children: source }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stage__body", children })
      ]
    }
  );
}
...
function JsonNode({ name, value, depth, openTo }) {
  const [open, setOpen] = reactExports.useState(depth < openTo);
  const kind = kindOf(value);
  const label = name === null ? null : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json__key", children: name });
  if (kind !== "object" && kind !== "array") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "json__row", style: { paddingLeft: `${depth * 14}px` }, children: [
      label,
      label ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json__colon", children: ":" }) : null,
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `json__scalar json__scalar--${kind}`, children: scalarText(value) })
    ] });
  }
  const entries = Array.isArray(value) ? value.map((item, index) => [String(index), item]) : Object.entries(value);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "json__branch", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json__caret", "aria-hidden": "true", children: "▸" }),
          label,
          label ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json__colon", children: ":" }) : null,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json__summary", children: summary(value) })
        ]
      }
    ),
...
function JsonView({ value, openTo = 1 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "json", children: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonNode, { name: null, value, depth: 0, openTo }) });
}
function JsonPanel({ title, value, openTo = 1, defaultOpen = false }) {
  const [open, setOpen] = reactExports.useState(defaultOpen);
  const text2 = reactExports.useMemo(() => JSON.stringify(value, null, 2), [value]);
  const size = reactExports.useMemo(() => `${(new Blob([text2]).size / 1024).toFixed(1)} КБ`, [text2]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `panel ${open ? "panel--open" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "panel__head", "aria-expanded": open, onClick: () => setOpen(!open), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "panel__caret", "aria-hidden": "true", children: "▸" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "panel__title", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "panel__size", children: size })
    ] }),
    open ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel__body", children: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonView, { value, openTo }) }) : null
  ] });
}
const ORIGIN_META = {
...
function onDemandIds(payload) {
  return tanksOf(payload).filter((tank) => tank.on_demand).map((tank) => tank.id);
}
function OriginBadge({ origin, label }) {
  ...
  if (!meta) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "origin origin--absent", role: "note", title: absent, "aria-label": absent, children: [
      label ? `${label}: ` : "",
      MISSING
    ] });
  }
...
function OriginLegend() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "origin-legend", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "origin-legend__head", children: "Происхождение чисел:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: "given" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "origin-legend__text", children: "требование ТЗ или ответ эксперта" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: "derived" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "origin-legend__text", children: "выведено из данных завода" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: "measured" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "origin-legend__text", children: "измерение с установки" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: "scenario" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "origin-legend__text", children: "допущение сценария, не измерение" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: "open" }),
    ...
    Section,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Происхождение состояния", children: payload.state_origin ?? "не указано" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Сценарий", children: payload.decision.scenario_id ?? "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Идентификатор решения", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: payload.decision.decision_id ?? "—" }) })
        ] }),
        operation ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "readouts", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Readout,
              {
                ...
                unit: "кг/т",
                badge: /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: origin?.additive_dose })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Рецепт смешения и запасы", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("caption", { children: [
              "Рецепт смешения и запасы ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: origin?.recipe, label: "рецепт" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Компонент" }),
          ...
          demand.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Note, { children: [
            "Компонент «",
            names[demand[0]] ?? demand[0],
            "» на складе не хранится: поле запаса у него пустое не потому, что склад опустел, а потому, что запаса у него не бывает. Его нарабатывают под заявку, и ограничением служит темп наработки, а не остаток. Разбавление этим компонентом оплачивается более глубокой очисткой — она дороже тонны основного потока, и эта разница входит в стоимость тонны на этапе «Выбор»."
          ] }) : null,
          tanks.some((tank) => tank.available === false) ? /* @__PURE__ */ jsxRuntimeExports.jsx(Note, { tone: "warn", children: "Компоненты, помеченные «выведен из работы», исключены условиями сценария: в смешение они не идут независимо от остатка." }) : null
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Текущий режим в решении не передавался." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          JsonPanel,
          {
...
function verdicts(report, fallback) {
      ...
      children: [
        sources.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Состояние источников не передавалось: в этом пути расчёта блок «доверие к данным» пуст. Пустое поле здесь означает отсутствие данных, а не их благополучие." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Источники качества", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Источник" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Значение серы" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Возраст" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Предел возраста" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Пригоден" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: sources.map((source2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("th", { scope: "row", children: [
                source2.name,
                report?.primary === source2.name ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { tone: "pass", children: "основной" }) : null
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "grid__num", children: hours(source2.age_hours) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "grid__num", children: hours(source2.max_age_hours) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(LampDot, { state: source2.usable ? "pass" : "fail" }),
                source2.status,
                source2.reasons.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid__reasons", children: source2.reasons.join("; ") }) : null
              ] })
            ] }, source2.name)) })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "readouts", children: [
          ...
          suspects.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Значения, помеченные к проверке", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("caption", { children: "Значения, помеченные к проверке" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Тег" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Значение" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Почему помечено" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: suspects.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: item.tag }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "grid__num", children: num(item.value, 3) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: item.note })
            ] }, `${item.tag}-${item.value}`)) })
          ] }) }) : null,
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Замер на момент", children: report?.as_of ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Недостающие требования", children: report?.missing_requirements?.length ? report.missing_requirements.join("; ") : "нет" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Причина отказа от данных", children: report?.refusal_reason ?? "нет" })
          ] }),
          report?.rule ? /* @__PURE__ */ jsxRuntimeExports.jsx(Note, { children: report.rule }) : null,
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Note, { children: [
            "Значения в этой таблице — единственные на странице, снятые с источников измерения. Всё остальное либо требование ТЗ, либо наш расчёт, либо допущение сценария; каждое помечено своим бейджем.",
...
function series(checks) {
  return checks.filter((check) => check.constraint_id === TRACKED && isNumber(check.observed) && isNumber(check.time_hours)).sort((a, b) => (a.time_hours ?? 0) - (b.time_hours ?? 0));
}
      ...
      children: [
        ...
        points.length === 0 ? payload.decision.status === "refuse" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Траектории серы здесь нет: её строят по проверкам выбранного плана, а плана нет. Пустой график означает отсутствие расчёта, а не благополучие по сере — уровень серы остаётся тем же, из-за которого план не нашёлся." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Точек по сере в проверках нет." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "readouts", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Readout,
              {
                ...
                hint: worst ? `на ${hours(worst.time_hours)}` : void 0,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Readout,
              {
                ...
                badge: /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: "given" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Readout,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Readout, { label: "Точек на горизонте", value: String(points.length), hint: "шагов проверки" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Trajectory,
            {
          ...
          statement ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Утверждение о сере", children: statement.text }),
            statement.evidence.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Field, { label: `Основание: ${item.kind}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(OriginBadge, { origin: item.kind === "scenario" ? "scenario" : "derived" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: item.ref }),
              " = ",
              num(item.value, 3),
              " — ",
              item.detail
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Note, { children: "Точки этой траектории — расчёт модели цепочки под выбранный план, а не измерения. Измеренные значения серы показаны отдельно на этапе «Доверие к данным», с возрастом каждого замера." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          JsonPanel,
          {
    ...
    Section,
    {
      ...
      children: [
        rounds.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Трасса оптимизатора не передавалась." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "readouts", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Readout, { label: "Планов рассмотрено", value: num(evaluated, 0), hint: "суммарно по раундам" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Readout,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Отсев по раундам", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Раунд" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Предложено" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Допустимо" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Вето качества" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Вето надёжности" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Семейства" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rounds.map((round) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "row", children: round.round }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "grid__num", children: num(round.proposed, 0) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Note, { children: "Число проверенных планов — это фактический перебор. Объявленный бюджет поиска на экран намеренно не вынесен: он расходуется не полностью и завысил бы полноту перебора." }),
          trace?.note ? /* @__PURE__ */ jsxRuntimeExports.jsx(Note, { children: trace.note }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(JsonPanel, { title: "JSON: трасса оптимизатора", value: trace ?? null, openTo: 2 })
      ]
    }
  );
}
      ...
      children: [
        checks.length === 0 ? payload.decision.status === "refuse" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Отдельного протокола Gate здесь нет, и это не пропуск: проверять было нечего — ни один план не дожил до финальной проверки. Что именно отсеяло варианты, показано на этапе «Решение» и в трассе оптимизатора на этапе «Кандидаты»." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Проверки Gate не передавались." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Проверки по семействам ограничений", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Семейство" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Пройдено" }),
          ...
          broken.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Что именно не прошло", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Наблюдалось" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Предел" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: shownBroken.map((check, position2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "grid__num", children: num(check.observed, 3) }),
...
function AgentCard({ event }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "agent", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "agent__head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "agent__name", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LampDot, { state: lampOf(event) }),
        TITLES[event.agent] ?? event.agent
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "agent__role", children: ROLES$1[event.agent] ?? "участник трассы" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { tone: lampOf(event), children: verdictText(event) })
    ] }),
    counters(event).length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("dl", { className: "agent__counters", children: counters(event).map(([label, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent__counter", children: [
...
function AgenticMode({ agentic }) {
  if (!agentic) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Режим работы агентов не передавался: по этому экрану нельзя сказать, работала ли живая модель." });
  }
  const tone = toneOf$1(agentic);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mode mode--${tone}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mode__headline", children: headline(agentic) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Режим", children: MODES[agentic.mode] ?? agentic.mode }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Исход", children: OUTCOMES[agentic.outcome] ?? agentic.outcome }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Провайдер", children: agentic.provider ?? "не задан" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Модель", children: agentic.model ?? "не задана" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Причина отката", children: agentic.fallback_reason ? /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: agentic.fallback_reason }) : "отката не было" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Статус детерминированного пути", children: agentic.legacy_status ?? "—" })
    ] }),
...
function Opinion({ opinion }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: `opinion opinion--${tone}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "opinion__head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "opinion__role", children: ROLES[opinion.role] ?? opinion.role }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { tone, children: VERDICTS[opinion.verdict] ?? opinion.verdict })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "opinion__meta", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Уровень риска" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: RISK[opinion.risk_level ?? ""] ?? opinion.risk_level ?? "не передан" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Уверенность" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: opinion.confidence === null ? "не передана" : num(opinion.confidence, 2) })
      ] })
    ] }),
    opinion.reasons.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "opinion__reasons", children: opinion.reasons.map((reason) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "opinion__text", children: reason.text }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "opinion__code", children: [
        "код: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: reason.code }),
        reason.candidate_id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          " · план ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: reason.candidate_id })
        ] }) : null
      ] })
    ] }, reason.code)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Обоснование не передавалось." }),
    opinion.proposed_constraints && opinion.proposed_constraints.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "opinion__proposal", children: [
      "Агент сам предложил ограничение:",
      " ",
      opinion.proposed_constraints.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("code", { children: [
        item.type,
        " ",
        item.limit,
        " ≥ ",
        num(item.value, 3)
      ] }, `${item.type}-${item.limit}`))
    ] }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsx(JsonPanel, { title: `JSON мнения «${opinion.role}»`, value: opinion, openTo: 2 })
  ] });
}
function Opinions({ agentic }) {
  const opinions = agentic?.opinions ?? [];
  if (opinions.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Мнения агентов не передавались." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opinions", children: opinions.map((opinion) => /* @__PURE__ */ jsxRuntimeExports.jsx(Opinion, { opinion }, opinion.role)) });
}
const ACTIONS = {
  select: "выбрать план",
...
function AgentFinal({ agentic }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "final", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "final__title", children: "Чем закончился диалог" }),
    final ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "final__summary", children: final.summary }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Действие", children: ACTIONS[final.action] ?? final.action }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "План", children: final.candidate_id ?? "план не выбран" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Коды причин", children: final.reason_codes.length > 0 ? final.reason_codes.join(", ") : "не передавались" })
      ] }),
      final.evidence_refs && final.evidence_refs.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "final__evidence", children: [
        "На чём основано: ",
    ...
    constraints.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "final__constraints", children: [
      ...
      " ",
      constraints.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("code", { children: [
        item.type,
        " ",
        item.limit,
        " ≥ ",
    ...
    budget ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Field, { label: "Вызовов модели", children: [
        num(budget.llm_calls, 0),
        " из ",
        num(budget.max_llm_calls, 0)
      ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Section,
    {
      ...
      children: [
        ...
        trace.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Сводная трасса участников не передавалась." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "agents__heading", children: "Сводка по участникам" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "agents", children: trace.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsx(AgentCard, { event }, event.agent)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Note, { children: "В трассе нет ни текста промптов, ни ключей, ни скрытых рассуждений: события несут только сводку вызова и результата. Это решение по безопасности аудита, а не обрезанная выдача." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          JsonPanel,
          {
    ...
    Section,
    {
      ...
      children: [
        plan ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "readouts", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Readout, { label: "Выбранный план", value: plan.plan_id, hint: plan.intent }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Readout,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Шаги плана по времени", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("caption", { children: "Шаги плана по времени" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Момент" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Уставки" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Рецепт" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Производительность" })
            ] }) }),
        ...
        alternatives.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Scroller, { label: "Ближайшие альтернативы", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: alternatives.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: item.candidate_id }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Устойчивость", children: payload.decision.robustness ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "выдержал ",
            payload.decision.robustness.held,
            " из ",
            payload.decision.robustness.perturbations_evaluated,
            " ",
            "возмущений",
            payload.decision.robustness.fragile ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { tone: "unknown", children: "чувствителен" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { tone: "pass", children: "держится" })
          ] }) : "не проверялась" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          JsonPanel,
...
function RefusalPanel({ payload }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "refusal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Fields, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Что это означает", children: kind ? KIND_TEXT[kind] ?? decision.reason : decision.reason }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Товарный выпуск разрешён", children: decision.commercial_release_allowed ? "да" : "нет" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Режим установки", children: "остаётся прежним: советчик ничего не меняет" })
    ] }),
    rounds.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "readouts", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Readout,
          {
    ...
    missing.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "limits", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "limits__list", children: missing.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, item)) })
    ] }) : null,
    steps.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("caption", { children: "Что изменило бы ответ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Условие или измерение" }),
...
function Logo({ className, title = "CUTPOINT" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      className,
      viewBox: "0 0 1000 143.6",
      role: "img",
      "aria-label": title,
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("g", { transform: "scale(0.088339)", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { transform: "translate(0 1546.0) scale(1 -1)", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "1050.7", y1: "733.0", x2: "1820.6", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "round" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "2117.8", y1: "733.0", x2: "2693.2", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "2990.4", y1: "733.0", x2: "3730.9", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "4028.0", y1: "733.0", x2: "4745.0", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "5787.4", y1: "733.0", x2: "6150.5", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "6452.4", y1: "733.0", x2: "7263.7", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "7570.2", y1: "733.0", x2: "7886.3", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "8183.4", y1: "733.0", x2: "8565.5", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "8843.8", y1: "733.0", x2: "8980.5", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "9301.3", y1: "733.0", x2: "9452.2", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "9730.5", y1: "733.0", x2: "10466.3", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "10763.4", y1: "733.0", x2: "11211.6", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "round" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "#322d2a", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("g", { transform: "translate(813.0 733.0) scale(3.39352 -3.39352) translate(-256.0 -256.0)", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M256 40a216 216 0 1 0 150 371l-59-62a132 132 0 1 1 0-186l59-62A215 215 0 0 0 256 40z" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { transform: "translate(1676.0 0)", d: "M147.0 1466.0H443.0V672.0Q443.0 483.0 454.0 427.0Q473.0 337.0 544.5 282.5Q616.0 228.0 740.0 228.0Q866.0 228.0 930.0 279.5Q994.0 331.0 1007.0 406.0Q1020.0 481.0 1020.0 655.0V1466.0H1316.0V696.0Q1316.0 432.0 1292.0 323.0Q1268.0 214.0 1203.5 139.0Q1139.0 64.0 1031.0 19.5Q923.0 -25.0 749.0 -25.0Q539.0 -25.0 430.5 23.5Q322.0 72.0 259.0 149.5Q196.0 227.0 176.0 312.0Q147.0 438.0 147.0 684.0Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { transform: "translate(3251.0 0)", d: "M479.0 0.0V1218.0H44.0V1466.0H1209.0V1218.0H775.0V0.0Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { transform: "translate(4598.0 0)", d: "M149.0 0.0V1466.0H624.0Q894.0 1466.0 976.0 1444.0Q1102.0 1411.0 1187.0 1300.5Q1272.0 1190.0 1272.0 1015.0Q1272.0 880.0 1223.0 788.0Q1174.0 696.0 1098.5 643.5Q1023.0 591.0 945.0 574.0Q839.0 553.0 638.0 553.0H445.0V0.0ZM445.0 1218.0V802.0H607.0Q782.0 802.0 841.0 825.0Q900.0 848.0 933.5 897.0Q967.0 946.0 967.0 1011.0Q967.0 1091.0 920.0 1143.0Q873.0 1195.0 801.0 1208.0Q748.0 1218.0 588.0 1218.0Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { transform: "translate(6060.0 0)", d: "M89.0 724.0Q89.0 948.0 156.0 1100.0Q206.0 1212.0 292.5 1301.0Q379.0 1390.0 482.0 1433.0Q619.0 1491.0 798.0 1491.0Q1122.0 1491.0 1316.5 1290.0Q1511.0 1089.0 1511.0 731.0Q1511.0 376.0 1318.0 175.5Q1125.0 -25.0 802.0 -25.0Q475.0 -25.0 282.0 174.5Q89.0 374.0 89.0 724.0ZM394.0 734.0Q394.0 485.0 509.0 356.5Q624.0 228.0 801.0 228.0Q978.0 228.0 1091.5 355.5Q1205.0 483.0 1205.0 738.0Q1205.0 990.0 1094.5 1114.0Q984.0 1238.0 801.0 1238.0Q618.0 1238.0 506.0 1112.5Q394.0 987.0 394.0 734.0Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { transform: "translate(7749.0 0)", d: "M140.0 0.0V1466.0H436.0V0.0Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { transform: "translate(8414.0 0)", d: "M152.0 0.0V1466.0H440.0L1040.0 487.0V1466.0H1315.0V0.0H1018.0L427.0 956.0V0.0Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { transform: "translate(9989.0 0)", d: "M479.0 0.0V1218.0H44.0V1466.0H1209.0V1218.0H775.0V0.0Z" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "2663.2", y1: "733.0", x2: "3020.4", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "4715.0", y1: "733.0", x2: "5817.4", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "7233.7", y1: "733.0", x2: "7600.2", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "8535.5", y1: "733.0", x2: "8873.8", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "9422.2", y1: "733.0", x2: "9760.5", y2: "733.0", stroke: "#c8761a", strokeWidth: "176.7", strokeLinecap: "butt" })
      ] }) })
    }
  );
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "masthead", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "masthead__text", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "masthead__title", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { className: "masthead__logo" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "masthead__sub", children: "Советчик оператору цепочки АВТ → гидроочистка → смешение. Путь числа от источника до рекомендации: сначала условия, затем восемь этапов по мере того, как сервер их отдаёт." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "masthead__meta", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "masthead__meta--verdict", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Вердикт" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "dd",
            {
              className: `masthead__verdict ${payload?.decision.status === "refuse" ? "masthead__verdict--refuse" : ""}`,
              children: payload ? payload.status_label : "прогона ещё не было"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Момент решения" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: payload ? moment(payload.decision_time) : "—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Сценарий" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: payload?.decision.scenario_id ?? (conditions.scenario || "—") })
        ] })
      ] })
    ] }),
