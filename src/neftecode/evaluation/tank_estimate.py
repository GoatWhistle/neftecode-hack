...
NOT_MEASURED_NOTE = ("Начальная сера резервуара прямыми пробами содержимого не измеряется: это среднее "
                     "доверенных показаний за окно обновления при допущении полного перемешивания.")
