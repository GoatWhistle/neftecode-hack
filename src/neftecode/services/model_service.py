...
def main(argv=None):
    args = build_parser().parse_args(argv); env = ServiceSettings.from_env("NEFTECODE_MODEL_")
    settings = ServiceSettings(host=args.host or env.host, port=args.port or 8767,
