...
COMPARISON_RULE = ("Планы сравниваются по порядку: больший выпуск, затем меньшая стоимость тонны. "
                   "Если сценарная политика разрешает небольшую разницу стоимости, внутри этого окна "
                   "выбирается меньшая тяжесть режима; затем меньшее число изменений и меньший идентификатор. "
                   "Жёсткие ограничения проверяются до сравнения.")
